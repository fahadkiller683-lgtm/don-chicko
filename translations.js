...
const translations = {
  en: {
    ...
    about: {
      ...
      visualAlt: "Hands holding a Don Chicko sandwich at the table, with roasted potatoes and dipping sauces",
    ...
    visit: {
      ...
      locationBodyHtml: "Don Chicko Restaurant<br>Palestine Street – near Al-Nakhla Intersection, Baghdad, Iraq",
      directionsLabel: "Get Directions",
      followTitle: "Reach Us",
      instagramLabel: "Instagram — @donchicko.iq",
      phoneLabel: "Call — +964 778 280 1000",
      hoursTitle: "Hours",
      hoursBody: "Open daily, 10 AM – 2 AM.",
      mapTitle: "Don Chicko location map",
    },
    footer: {
      social: "Instagram",
    ...
    menuPage: {
      ...
      noteHtml: 'Prices shown in Iraqi Dinar. Menu subject to change — follow <a href="https://www.instagram.com/donchicko.iq/" target="_blank" rel="noopener">@donchicko.iq</a> for new arrivals.',
    },
  },
  ...
  ar: {
    ...
    about: {
      ...
      visualAlt: "يدان تمسكان بساندويتش دون تشيكو على الطاولة، مع بطاطا محمّصة وصلصات غموس",
    ...
    visit: {
      ...
      locationBodyHtml: "مطعم دون تشيكو<br>شارع فلسطين - قرب تقاطع النخلة، بغداد، العراق",
      directionsLabel: "احصل على الاتجاهات",
      followTitle: "تواصل معنا",
      instagramLabel: "إنستغرام — ⁦@donchicko.iq⁩",
      phoneLabel: "اتصل — 07782801000",
      hoursTitle: "ساعات العمل",
      hoursBody: "مفتوحون يوميًا من الساعة 10 صباحًا حتى 2 فجرًا.",
      mapTitle: "خريطة موقع دون تشيكو",
    },
    footer: {
      social: "إنستغرام",
    ...
    menuPage: {
      ...
      noteHtml: 'الأسعار بالدينار العراقي، وقابلة للتغيير دون إشعار مسبق. تابعوا <a href="https://www.instagram.com/donchicko.iq/" target="_blank" rel="noopener">⁦@donchicko.iq⁩</a> لمعرفة أحدث الإضافات.',
    },
  },
};
