...
const translations = {
  en: {
    ...
    about: {
      ...
      visualAlt: "Don Chicko badge: the secret ingredient is always love",
    ...
    visit: {
      ...
      instagramLabelHtml: "Instagram — @donchicko.iq",
  ...
  ar: {
    ...
    about: {
      ...
      visualAlt: "شعار دون تشيكو: السر الحقيقي دائمًا هو الحب",
    ...
    visit: {
      ...
      instagramLabelHtml: "إنستغرام — <bdi>@donchicko.iq</bdi>",
    ...
    menuPage: {
      ...
      tagAll: "الكل",
      noMatch: "لا توجد أصناف تطابق هذا الفلتر.",
    },
  },
};
